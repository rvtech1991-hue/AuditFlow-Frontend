...
export const routes: RouteMeta[] = [
  ...
  { path: "/users", title: "User management", subtitle: "Tenant user table placeholder.", access: ["Auditor", "Company admin", "Platform admin"] },
...
export const navItems: NavItem[] = [
  ...
  { label: "Users", path: "/users", roles: ["Auditor", "Company admin", "Platform admin"], group: "Manage", icon: "◉" },
